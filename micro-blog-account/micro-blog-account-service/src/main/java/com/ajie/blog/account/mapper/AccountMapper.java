...
public interface AccountMapper extends BaseMapper<AccountPO> {
    @Insert({"<script>",
            "insert into mb_account (id,account_name,nick_name,password,mail,phone,gender,personal_sign,header_url,create_person,update_person,create_time,update_time,del) ",
            "select #{id}, #{po.accountName},#{po.nickName},#{po.password},#{po.mail},#{po.phone},#{po.gender},#{po.personalSign},#{po.headerUrl},#{id},#{id},now(),now(),0 ",
            "from DUAL ",
